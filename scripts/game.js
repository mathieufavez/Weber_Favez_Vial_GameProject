...
Game.World = function(friction = 0.9) {
    ...
    this.map = [25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25,
                25, 10, 10, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 10, 10, 25,
                25, 10, 25, 24, 25, 24, 25, 24, 25, 24, 25, 24, 25, 24, 25, 24, 25, 24, 25, 10, 25,
                25, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 25,
    ...
    this.collision_map =   [10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10,
                            10, 12, 12, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 12, 12, 10,
                            10, 12, 10, 11, 10, 11, 10, 11, 10, 11, 10, 11, 10, 11, 10, 11, 10, 11, 10, 12, 10,
...
Game.World.Collider = function() {
    ...
    this.collide = function(value, object, tile_x, tile_y, tile_size) {
        ...
        switch(value) { // which value does our tile have?
            ...
            case 10:    if (this.collidePlatformTop  (object, tile_y            )) return;
                        if (this.collidePlatformLeft (object, tile_x            )) return;
                        if (this.collidePlatformRight(object, tile_x + tile_size)) return;
                        this.collidePlatformBottom   (object, tile_y + tile_size); break;
...
Game.World.Player = function(x, y) {
    ...
    Game.World.Object.call(this, 32, 32, 20, 20);
